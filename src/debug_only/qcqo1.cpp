...
#include "pcd_trajectory/mosek.h" /* Include the MOSEK definition file. */
...
int main (int argc, char** argv) {
  ...
  {   
    ...
    for(i=0; i<NUMCON && r==MSK_RES_OK; ++i)
            ...
            if ( r==MSK_RES_OK )
      {
        ...
        qsubi[2] = 2;   qsubj[2] = 2;  qval[2] = -0.6;
        qsubi[3] = 2;   qsubj[3] = 1;  qval[3] = 0.5;

        /* Put Q^0 in constraint with index 1. */
  ...
  ROS_WARN("Time consume in QCQP is : ");
